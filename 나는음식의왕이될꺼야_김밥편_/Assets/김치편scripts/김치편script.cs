...
{   public GameObject BlackMove;
    ...
    string[] dialogues = { "잠깐!!! ", 
        "어디서 매 식사마다 안나오는 것이 음식의 왕이 되려 해!!! ", "뭐냐!! 너도 음식의 지배자가 되고 싶은거냐!! ",
    "당연하지!! 김치 없으면 음식들이 넘어가기나 해???", "어디에나 있어야하는 존재가 당연히 지배자의 자질 아니겠어? ","크윽...어쩔 수 없군.... 음식 배틀로 붙자!!! ","흥! 당연히 나의 승리지!!! "}; // Array of dialogues to display  //꼭 스페이스를 마지막에 눌러주세요
